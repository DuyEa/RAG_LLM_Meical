...
from qdrant_client.http.models import Distance, VectorParams, PointStruct, Filter, FieldCondition, MatchAny, PayloadSchemaType
...
# Extract texts with metadata (title + text)
texts_with_meta = []
seen_titles = set()
for item in dataset:
